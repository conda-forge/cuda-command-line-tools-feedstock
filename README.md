...
pixi add cuda-command-line-tools
# for installing globally
pixi global install cuda-command-line-tools
```
...
It is possible to list all of the versions of `cuda-command-line-tools` available on your platform:
...
```
pixi search cuda-command-line-tools --channel conda-forge
```
